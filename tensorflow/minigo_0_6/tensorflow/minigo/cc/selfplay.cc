...
#include "constants.h"
#include "dual_net/batching_dual_net.h"
#include "dual_net/factory.h"
#include "dual_net/reloading_dual_net.h"
#include "file/path.h"
...
//        LogEndGameInfo(*game, absl::Now() - start_time);
	...
	// undefined reference to below function, place a "+" to merge two strings
	// in order to fit the number of arguments for tf_utils::WriteGameExamples()
