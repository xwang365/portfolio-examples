...
#this should be under: tensorflowview/tensorflow/
./tensorflow/contrib/lite/tools/make/download_dependencies.sh
#make -f tensorflow/lite/tools/make/Makefile
make -j $(nproc) -f tensorflow/contrib/lite/tools/make/Makefile
#cp tensorflow/lite/tools/make/gen/linux_x86_64/lib/libtensorflow-lite.a, which is based one eigen from public domain
#-I/mnt/data/zhenyingl/tensorflowview/tensorflow/tensorflow/lite/tools/make/downloads/eigen
